...
const Todo = () => {
  ...
  const add = () => {
    ...
    return (
      <div className="bg-transparent border place-self-center w-11/12 max-w-sm  min-h-[550px] rounded-xl p-7 flex flex-col my-16">
        <div className="flex gap-2 px-4 items-center">
          <LuListTodo className="text-3xl text-orange-500" />
          <h1 className="text-3xl font-semibold text-zinc-200 font-semibold">Todo List</h1>
        </div>
        ...
        <div className="flex items-center justify-center border  rounded-full my-5">
          ...
          <button onClick={add}>
            <IoMdAdd
              className="bg-orange-500 text-white text-2xl
